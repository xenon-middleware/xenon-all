...
1. make sure the artifacts can be build by running ``./gradlew publishToMavenLocal``;
1. make sure the adaptors page is up-to-date by running ``./gradlew publishSite``;
